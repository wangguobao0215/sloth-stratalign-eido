...
<p align="center">
  <strong>深略 · StratAlign — 管理咨询顾问的战略对齐加速器</strong><br/>
...
> **深略**——「深」取自树懒老K品牌哲学「慢一点，深一度」，「略」意为谋略、战略。战略不是PPT上的口号，是需要深入拆解、层层对齐的系统工程。深略，以深度谋略驱动战略从愿景到落地。

## 这是什么？

深略 · StratAlign 是一款面向**管理咨询顾问**的战略对齐加速器。通过行业剧本预填、结构化问卷引擎和 AI 原生潜力评分，将顾问在数字化转型战略项目中的数据收集、分析建模、报告撰写效率提升 3-5 倍。
